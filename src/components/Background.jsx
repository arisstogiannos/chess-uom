...
export default function Background({page}) {
  return (
    ...
    <Image src="/bgV2.webp" unoptimized={true} alt="bg" priority fill  className="invisible md:visible pointer-events-none  fixed top-0 left-0 -z-10  " />
    <Image src="/bgV2-mobile.webp" unoptimized={true} alt="bg" priority fill className="visible md:invisible fixed top-0 left-0 -z-10  pointer-events-none " />
