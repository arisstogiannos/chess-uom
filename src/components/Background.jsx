...
export default function Background({page}) {
  return (
    ...
    <Image src="/bgV2.webp" unoptimized={true} alt="bg" priority fill className="invisible md:visible  fixed top-0 left-0 -z-10 h-screen w-screen " />
    <Image src="/bgV2-mobile.webp" unoptimized={true} alt="bg" priority fill className="visible md:invisible fixed top-0 left-0 -z-10 h-screen w-screen " />
