  ...
  return (
    <>
      <main className="h-[120vh] ">
        <div id="canvas3d"  className=" absolute left-[50%] -translate-x-1/2 top-[600px] md:top-2/3 3xl:top-[60%] -translate-y-1/2 w-screen h-[100vh] max-md:pointer-events-none  ">
          <Spline
            onLoad={onLoad}
...
function socials() {
  return (
    <div className="py-6 sm:py-0 px-16 border-y sm:border-y-0 sm:px-10  sm:border-r flex gap-10 scale-90">
      ...
      {/* instagram */}
      <a href="https://www.instagram.com/chess_uom?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw%3D%3D" target="_blank">
        <svg
          width="31"
          height="30"
          viewBox="0 0 31 30"
